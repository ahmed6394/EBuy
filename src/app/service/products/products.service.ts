...
export class ProductsService {
  ...
  getAllProductsByCategory(category: string): Products[] {
    return category == 'All'
      ? this.getAll()
  ...
  getAllCategory(): Category[] {
    return [
      { name: "Men's Sneaker", count: 9 },
      { name: 'T-shirt', count: 10 },
      { name: "Men's Boot", count: 10 },
      { name: "Men's Pant", count: 10 },
      { name: 'Bag', count: 10 },
      { name: 'Cap', count: 10 },
      { name: 'Earphones', count: 6 },
  ...
  getAll(): Products[] {
    return [
      ...
      },
      {
        id: 2,
        category: "Men's Sneaker",
        name: 'LUNAR NEW YEAR ULTRABOOST SHOES',
        seller: 'Addidas',
        price: 196,
        stock: 19,
        ratings: 5,
      ...
      },
      {
        id: 29,
        category: "Men's Boot",
        name: 'TERREX AGRAVIC RUNNING SHOES',
        seller: 'Addidas',
        price: 118,
        stock: 8,
        ratings: 3,
      ...
      },
      {
        id: 30,
        category: "Men's Boot",
        name: 'TERREX COLD.RDY HIKING BOOTS',
        seller: 'Addidas',
        price: 169,
        stock: 17,
        ratings: 5,
